...
export const en = defineBlogPostMetadata({
	...
	description: "Introducing the Svelte preprocessor API via analysis of a practical, simple use case and one possible minimal solution. If you haven't written a preprocessor before, it's time!",
...
export const vi = defineBlogPostMetadata({
	...
	description: 'Giới thiệu sơ bộ cách hoạt động của Svelte preprocessor bằng cách phân tích một vấn đề thường gặp và tìm phương án giải quyết tối giản nhất',
	publishedAt: new Date('2023-10-20'),
	authors: ['vnphanquang'],
	categories: ['svelte-and-kit'],
	keywords: 'preprocessor',
