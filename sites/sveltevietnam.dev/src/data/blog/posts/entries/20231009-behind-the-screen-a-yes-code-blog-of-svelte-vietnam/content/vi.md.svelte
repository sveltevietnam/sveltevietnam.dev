...
<img
  src={authorsImg}
  alt="hai người đang ngồi thảo luận về việc sáng tạo nội dung"
  loading="lazy"
  decoding="async"
...
<img
  src={confusedManImg}
  alt="một người đang cảm thấy bối rối và khó chịu"
  loading="lazy"
  decoding="async"
  class={commonImageClasses}
  height="320"
...
<img
  ...
  alt="hình chụp màn hình đoạn code miêu tả đối tượng metadata cho bài viết được code cứng"
  loading="lazy"
  decoding="async"
...
<img
  ...
  alt="góc nhìn từ trên xuống cuốn sổ và cây bút trên bàn"
  loading="lazy"
  decoding="async"
  class={commonImageClasses}
  height="320"
...
<img
  src={ctaWriteImg}
  alt="một bạn cầm một cây bút to và trông rất hào hứng"
  loading="lazy"
  decoding="async"
  class={commonImageClasses}
  height="360"
