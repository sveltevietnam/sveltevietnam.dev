<script lang="ts">
  ...
  const commonImageClasses = 'tablet:w-max-142 mx-auto max-w-full h-auto';
</script>
...
<img
  src={authorsImg}
  alt="two people sitting at table and discussing creative work"
  loading="lazy"
  decoding="async"
...
<svg inline-src="../images/tech-and-bug" class="my-8 mx-auto max-w-full w-80 h-auto" />
...
<img
  ...
  alt="screenshot of hardcoded post metadata object"
  loading="lazy"
  decoding="async"
  class="rounded-lg mx-auto h-auto w-full"
  height="320"
  width="570"
/>

This can also lead to inconsistency and incohesion between data among different posts. If changes arise, refactor is difficult and time-consuming. Currently, Blog uses [hygen](http://www.hygen.io/) as a scaffolding tool to automate part of the post creation process, ensuring an initial consistency. Besides, [MDSvex](https://github.com/pngwn/MDsveX) is set up to utilize Markdown syntax in post content, simplifying common and verbose HTML code blocks.
...
<img
  ...
  alt="top-down view of sketch book with pencil on table"
  loading="lazy"
  decoding="async"
  class={commonImageClasses}
  height="320"
...
<img
  src={ctaWriteImg}
  alt="a happy girl holding a giant pencil"
  loading="lazy"
  decoding="async"
  class={commonImageClasses}
  height="360"
