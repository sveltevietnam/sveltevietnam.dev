  ...
  milestones: {
    ...
    tu: {
      ...
      primaryTasks: [
        ...
        `☐ Ra mắt văn bản “Technical Reference” và “<a class="c-link" href="https://github.com/sveltevietnam/sveltevietnam.dev/blob/main/CONTRIBUTING.md" rel="noreferrer" target="_blank">Contributing Guidelines</a>”`,
