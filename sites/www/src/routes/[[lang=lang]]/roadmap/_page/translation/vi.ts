  ...
  milestones: {
    aulac: {
      ...
      primaryTasks: [
        ...
        `☑ Công bố <a class="c-link" href="${HOME_PATH}">Trang chủ</a> với thiết kế sơ khởi`,
        ...
        `☑ Công bố trang <a class="c-link" href="${ROADMAP_PATH}">Lộ trình</a>`,
      ],
    },
    tu: {
      title: 'Tự',
    ...
    dong: {
      ...
      primaryTasks: [
        ...
        `☐ Công bố trang <a class="c-link" href="${JOBS_PATH}">Việc làm</a> với thiết kế sơ khởi`,
