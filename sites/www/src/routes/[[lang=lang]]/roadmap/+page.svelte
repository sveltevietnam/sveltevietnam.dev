...
<main class="c-container-design">
  ...
  <div class="space-y-[60px] tb:space-y-[120px] py-[60px] tb:pb-[200px] tb:pt-[120px]">
    <section class="relative">
      ...
      <div use:intersect class="absolute top-0 right-0 -z-px">
        <svg
          inline-src="./_page/images/au-lac"
          class="opacity-[2%] upto-tb:w-full upto-tb:h-auto upto-tb:top-[100px]"
        />
      </div>
    </section>
    ...
    <section class="relative">
      ...
      <div class="absolute bottom-0 right-0 -z-px" use:intersect>
        <div class="flex items-center gap-10 upto-tb:flex-col upto-tb:max-h-full opacity-[2%]">
    ...
    <section class="relative">
      ...
      <div class="absolute bottom-0 right-0 -z-px" use:intersect>
        ...
        <svg inline-src="./_page/images/dong" class="opacity-[2%] max-h-full" />
      </div>
    </section>
  </div>
</main>
