...
export const post = {
	...
	title: {
		en: 'Progressive SplashScreen (Behind the Screen)',
		vi: 'Màn hình chờ với nâng cao tăng dần (Behind the Screen)',
	},
	description: {
		en: 'How sveltevietnam.dev implements a SplashScreen with progressive enhancement that buys time for page animation to load and improve user experience',
