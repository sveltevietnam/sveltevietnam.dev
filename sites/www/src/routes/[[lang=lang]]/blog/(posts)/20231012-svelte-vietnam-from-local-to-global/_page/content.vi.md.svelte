...
Lúc bấy giờ, mục tiêu của mình không phải là thay thế React, mà chỉ đơn thuần là tái cơ cấu và áp dụng các giải pháp giúp hoàn thiện trải nghiệm và cải thiện tốc độ của lập trình viên (developer experience), tiêu biểu là Hot Module Replacement (HRM) vì trước đó, mỗi khi đổi code thì phải chờ thật lâu để cả ứng dụng được build lại. Và rồi tìm thứ này lại ra thứ khác, mình quyết đinh thử [Snowpack](https://www.snowpack.dev/tutorials/svelte)*. Snowpack là một công cụ thay thế webpack, tận dụng ES module để tải code trực tiếp qua dev server mà không cần đóng gói (bundle) như trước. Bạn có thể tham khảo thêm [tài liệu của Snowpack để hiểu thêm cách hoạt động](https://www.snowpack.dev/concepts/how-snowpack-works). Nói ngắn gọn nó có ý tưởng rất đột phá, và rất, rất nhanh. Cùng lúc đấy, cộng đồng Svelte cũng quan tâm đến ý tưởng tương tự, mối liên kết của Svelte và Snowpack khá chặt chẽ (hãy đọc qua [issue cũ rích này](https://github.com/sveltejs/sapper/issues/1204) nếu muốn biết thêm). Rich Harris, tác giả của Svelte, cũng đã nhiều lần khen ngợi Snowpack. Thế là mình quyết định thử xem Svelte có gì hay, rồi dần dần đã chìm sâu vào hệ sinh thái này lúc nào không hay.

Trở lại năm 2022, đây là một năm quan trọng với Svelte. Trước đó [Rich Harris](https://github.com/Rich-Harris) đã rời công việc của anh tại The New York Times, [tham gia Vercel](https://vercel.com/blog/vercel-welcomes-rich-harris-creator-of-svelte), theo sau là [Simon](https://github.com/dummdidumm). Hai người này cùng rất nhiều thành viên khác trong core team Svelte đã thúc đẩy phát triển [Svelte Kit](https://svelte.dev/blog/sveltekit-beta)*, một metaframework vượt trội (so sánh như Next cho React hay Nuxt cho Vue vậy). Cộng đồng Svelte theo đà đã phát triển rộng và sâu hơn một cách nhanh chóng ([Svelte Discord](https://svelte.dev/chat), [Svelte Society](https://sveltesociety.dev/), [Svelte Radio](https://www.svelteradio.com/), [Svelte Summit](https://www.sveltesummit.com/), [Svelte Sirens](https://sveltesirens.dev/), và nhiều cộng đồng nhỏ trên nhiều quốc gia). Tháng 12, [Svelte Kit 1.0 chính thức ra mắt](https://svelte.dev/blog/announcing-sveltekit-1.0). Vậy là mình không còn lý do gì để nghi ngờ sự phát triển của Svelte. Mình đoán rằng lập trình viên cũng như doanh nghiệp lớn nhỏ dần sẽ tìm đến Svelte giống như một giải pháp thực tế, nghiêm túc như React hay Vue vậy. Lúc này, Svelte tại Việt Nam vẫn còn rất cục bộ, thiếu liên kết, thông tin, và một cộng đồng. Đó chính là lý do Svelte Việt Nam ra đời.

::: div tp-cap2
\* Snowpack đã dừng phát triển. Thay vào đó là [Vite](https://vitejs.dev/) đến từ cộng đồng [Vue](https://vuejs.org/). Ngày nay, hai cộng đồng Vite và Svelte cũng có nhiều liên kết chặt chẽ tương tự.

\* Svelte Kit được xem là thay thế cho [Sapper](https://sapper.svelte.dev/), một metaframwork trước đó của Svelte, nhưng đã dừng phát triển để chuyển hướng sang Svelte Kit.
:::
...
Svelte Việt Nam không có ý định cạnh tranh với các cộng đồng khác tại Việt Nam như Vue, React, … Nếu bạn tham gia Discord, có thể bạn cũng đã thấy lời nhắn của mình rằng hãy thoải mái trao đổi nhưng tránh so sánh hay chê bai các công nghệ khác. Sự thật là, chúng ta không thể tránh so sánh được. So sánh giúp ta nhìn nhận sự khác biệt và tương đồng, nhưng đôi khi ta bị cuống vào cái khác mà quên đi rằng có rất nhiều cái giống. Vừa rồi, [Vite Conference](https://viteconf.org/23/) diễn ra với sự góp mặt của các thành viên từ rất nhiều cộng đồng khác nhau, không ai nói rằng “vì Vite xuất phát từ Vue nên tôi sẽ không dùng nó đâu”. Một ví dụ khác với công bố trong tháng vừa qua từ team Svelte về [Rune](https://svelte.dev/blog/runes), chúng ta học được rằng Svelte đã lấy ý tưởng từ tất cả các framework nổi tiếng, và hầu hết các framework front-end ngày nay đều bằng cách này hay cách nọ đi theo hướng Signal, là cái mà [Knockout](https://knockoutjs.com/) đã thực hiện cách đây rất nhiều năm. Khi một framework thắng thì tất cả cùng thắng, chứ không phải là những cái khác sẽ thua. Như vậy, chúng ta giống nhau nhiều hơn ta tưởng.
...
Từ nãy giờ, mình đã trả lời câu hỏi “Svelte Việt Nam là gì” bằng góc nhìn hết sức chủ quan. Trong giai đoạn sơ khởi này, mình muốn Svelte Việt Nam là tất cả những thứ trên. Tuy nhiên, Svelte Việt Nam sẽ thay đổi theo cộng đồng của nó. Bây giờ nó là một hình vẽ, câu chữ trong cuốn sổ tay của mình. Chính cộng đồng mới là thứ sẽ xây dựng một Svelte Việt Nam có hình thù và màu sắc cụ thể. Màu sắc và hình thù đó là gì không ai có thể biết được. Nó là một dấu chấm hỏi mà mình sẽ luôn dõi theo mỗi ngày.

## Tổng kết

Tóm lại, Svelte là một dự án open source chào đón mọi người đóng góp, một cộng đồng mở, một thí nghiệm xã hội, và sẽ trở thành một thứ gì đó được nhào nặn từ chính cộng đồng. Mình hy vọng rằng, Svelte Việt Nam sẽ là một khu vườn nhà mà trong đó các cây lúa, bông hoa sẽ lớn lên và bay đi khắp mọi nơi.
