...
Theo mặc định, mỗi thông báo có một đồng hồ hẹn giờ bên trong: thông báo sẽ tự động biến mất khi hết giờ hẹn trong vài giây. Tuy nhiên, khi bạn rê chuột vào thông báo (hay chạm và giữ tay trên các thiết bị chạm), đồng hồ sẽ tạm dừng để bạn có thời gian đọc hoặc tương tác với thông báo, ví dụ như sao chép nội dung hoặc lựa chọn hành động phù hợp. Bạn có thể thử nghiệm bằng cách nhấn vào nút sao chép đường dẫn trong phần "[Chia sẻ](#share)" của bài viết này.
...
Khi bạn mở trang web trên các thiết bị hoặc môi trường giới hạn về đường truyền như 3G, hoặc nơi phủ sóng kém, bạn có thể gặp phải thông báo sau:
...
:::div c-callout c-callout--info
Mô hình trên đã có ở các nước phát triển nhưng còn ít tại Việt Nam. Mình có nhắc đến điều này trong bài viết "[Svelte Việt Nam: từ vườn nhà vươn ra thế giới](/blog/20231012-svelte-vietnam-from-local-to-global)". Nếu có thể bạn hãy đọc thêm để hiểu thêm về định hướng phát triển của Svelte Việt Nam nhé!
:::
...
Nếu bạn đọc bài viết này trong tương lai, có thể giao diện trang 404 đã khác đi, nhưng hy vọng bạn sẽ thấy lời nhắn tương tự. Khi nhấn vào đường dẫn "Would you like a blue screen?", bạn sẽ được chào đón bằng một màn hình xanh nổi tiếng (chắc hẳn sẽ không xa lạ với các bạn 8x, 9x):
