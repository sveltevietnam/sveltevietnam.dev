...
export const vi = {
	...
	fromRecruitmentSites: {
		...
		notice: `Tính năng đang được phát triển để tự động tổng hợp việc làm từ các kênh tuyển dụng phổ biến tại Việt Nam. Xem <a class="c-link" href=${ROADMAP_PATH}>Roadmap</a> để biết thêm chi tiết.`,
		tba: {
