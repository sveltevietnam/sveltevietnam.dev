...
export const en = {
	...
	introduction: {
		...
		description: [
			...
			'You may find that this blog operates a bit differently compared to other systems. Read "<a href="/en/blog/20231009-behind-the-screen-a-yes-code-blog-of-svelte-vietnam" class="c-link">Behind the Screen: A Yes-code Blog of Svelte Vietnam</a>" to understand the decisions behind its infrastructure design.',
