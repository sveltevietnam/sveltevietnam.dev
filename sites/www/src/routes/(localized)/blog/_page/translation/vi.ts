...
export const vi = {
	...
	introduction: {
		...
		description: [
			...
			'Bạn có thể bắt gặp một số khác biệt về phương thức và quy trình vận hành của blog so với các hệ thống khác. Đọc thêm “<a href="/vi/blog/20231009-behind-the-screen-blog-chay-bang-com-va-code" class="c-link">Behind the Screen: blog chạy bằng cơm (và code)</a>” để hiểu thêm những quyết định đằng sau thiết kế hạ tầng của trang Blog Svelte Việt Nam.',
