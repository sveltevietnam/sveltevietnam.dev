...
:::div c-callout c-callout--info
Noitce the usage of [:where](https://developer.mozilla.org/en-US/docs/Web/CSS/:where) to control the [specificity](https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity) of this selector so that it can be overridden depending on each specific use case. This is a common technique often seen in CSS libraries.
:::
...
- If constraint on markup or special logic is needed, *consider* making Javascript component. Examples of this at *sveltevietnam.dev* are `Breadcrumbs`, `BlogPostItem`, `SplitText`, ...
...
In the next and last part, "[Styling Svelte Vietnam: Part III - Code Discovery & Portability](/blog/20240125-styling-svelte-vietnam-part-iii-code-discovery-portability)", I will connect Tailwind from the previous part with the CSS component mindset in this part, and explain in more detail how *sveltevietnam.dev* actually sets up CSS component. Join [Svelte Vietnam Discord](https://discord.sveltevietnam.dev) for further discussion. Thank you for reading!
