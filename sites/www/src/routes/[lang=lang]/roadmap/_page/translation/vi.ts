	...
	milestones: {
		aulac: {
			...
			primaryTasks: [
				...
				`☑ Thiết lập metadata và SEO cơ bản, bao gồm <a class="c-link" href="${SITEMAP_PATH}" rel="noreferrer" target="_blank">sitemap.xml</a>, Google Search Console, Google Analytics`,
