...
test('can generate module with only simple message', () => {
	...
	expect(mod).toEqual(js`
		...
		import { createMessageSimple } from "@sveltevietnam/i18n-new/factory";
...
test('can generate module with only with-params message', () => {
	...
	expect(mod).toEqual(js`
		...
		import { createMessageWithParams } from "@sveltevietnam/i18n-new/factory";
...
test('can generate module with all types of message', () => {
	...
	expect(mod).toEqual(js`
		...
		import { createMessageSimple, createMessageWithParams } from "@sveltevietnam/i18n-new/factory";
