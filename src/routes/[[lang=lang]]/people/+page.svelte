...
<main class="c-page">
  ...
  <div class="actions">
    ...
    <section class="c-action-card">
      ...
      <ol>
        <li>
          <svg class="marker" data-inline-src="google/volunteer-activism" />
          <p class="text">{t.how.steps.contribute}</p>
        </li>
        <li>
          <svg class="marker" data-inline-src="google/thumb-up" />
          <p>{t.how.steps.nominate}</p>
        </li>
        <li>
          <svg class="marker" data-inline-src="google/verified" />
          <p>{t.how.steps.verify}</p>
        </li>
        <li>
          <svg class="marker" data-inline-src="google/social-leaderboard" />
